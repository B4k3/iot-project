...
<simconf>
  ...
  <simulation>
    <title>SmartUrbanWaste-sim</title>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/Bin/rpl-border-router/border-router.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/Bin/bin-motes/bin.c</source>
      <commands>make bin.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>6.167701306868523</x>
        <y>75.80494247648704</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>11.882385043045119</x>
        <y>65.60773545370152</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.7704657694408015 0.0 0.0 4.7704657694408015 0.10701750488911792 -141.92227912911272</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
